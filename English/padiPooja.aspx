<%@ Page Language="C#" MasterPageFile="~/Master/English.Master"   AutoEventWireup="true" CodeBehind="padiPooja.aspx.cs" Inherits="Artha.English.padiPooja" %>
...
<%--<tr> <td colspan="6">  <a href="3_3_4.aspx">  <span class="clickHere" >  படித்திருவிழா  பற்றிய குறிப்புகள் </span> </a> </td> </tr>--%>
				<tr> 
                    <td colspan="6"> <img src="../Tamil/Images/blue1.jpg" width="14" height="13" /> 
					    <span class="content_heading_english">  Padiththuiruvilza  </span>  
                    ...
                    <tr> 
						<td> <li><a href="#"><img src="../Tamil/Images/padiPooja/1.jpg"  class="img-zoom" /></a></li> </td>
						<td> <li><a href="#"><img src="../Tamil/Images/padiPooja/2.jpg"  class="img-zoom" /></a></li> </td>
						<td> <li><a href="#"><img src="../Tamil/Images/padiPooja/3.jpg"  class="img-zoom" /></a></li> </td>
						<td> <li><a href="#"><img src="../Tamil/Images/padiPooja/4.jpg"  class="img-zoom" /></a></li> </td>
						<td> <li><a href="#"><img src="../Tamil/Images/padiPooja/5.jpg"  class="img-zoom" /></a></li> </td>
						<td> <li><a href="#"><img src="../Tamil/Images/padiPooja/6.jpg"  class="img-zoom" /></a></li> </td>
					</tr>
