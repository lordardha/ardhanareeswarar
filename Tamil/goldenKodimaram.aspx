<%@ Page Language="C#" MasterPageFile="~/Master/Artha.Master" AutoEventWireup="true" CodeBehind="goldenKodimaram.aspx.cs" Inherits="Artha.Tamil.goldKodimaram" %>
...
<tr> <td colspan="7">  <a href="6_5.aspx">  <span class="clickHere" >  தங்க கொடிமரம் பற்றிய குறிப்புகள்   </span> </a> </td> </tr>

				<tr> 
                    <td colspan="7"> <img src="images/blue1.jpg" width="14" height="13" /> 
					    <span class="content_heading">  தங்க கொடிமரம் - புகைப்பட தொகுப்பு </span>  
